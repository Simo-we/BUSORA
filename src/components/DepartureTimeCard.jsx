  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.chipsRow}>
        {['Now', 'Today', 'Tomorrow'].map((item) => (
          <TouchableOpacity
            key={item}
            activeOpacity={0.8}
            onPress={() => setQuickOption(item)}
            style={[styles.chip, quickOption === item && styles.activeChip]}
          >
            <Text style={[styles.chipText, quickOption === item && styles.activeChipText]}>
              {item}
            </Text>
          </TouchableOpacity>
        ))}
      ...
      <Text style={styles.helperText}>
        We'll tailor buses around your preferred time
      </Text>
